...
let i = 0;
   Journalists.forEach(str => {
       if (str.match(/\d/)) {
           i++;
       }
   });
console.log(`Il y a ${i} handles qui contiennent un numéro`);
...
console.log(`Il y a ${j} handles qui contiennent les 4 lettres du prénom Aude`)
...
console.log(`Il y a ${k} handles qui contiennent un @ suivi d'une majuscule`)
...
console.log(`Il y a ${l} handles qui contiennent une majuscule`)
...
console.log(`Il y a ${m} handles qui contiennent un underscore`)
...
let short_50 = Journalists.sort(function(a,b) {
            return a.length - b.length;
           });

console.log(short_50.slice(0,50));
